 ...
 import logo from '../assets/khaled nashwan.png'
    ...
    <div className=" pt-16  sm:max-w-2xll md:max-w-full lg:max-w-screen-xxl md:px-24 lg:px-8 line__col mb-0 max-md:px-3 ">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          >
            <span className="ml-2  w-36 tracking-wide ">
              <img src={logo} alt="" />
            </span>
          </a>
        </div>
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            <p className="mr-1">Address : Gaza , Palestine</p>
          </div>
        </div>
        <div>
          ...
          <div className="flex items-center mt-1 space-x-3">
            ...
            <a
              href="https://www.instagram.com/khaled25nash/"
              className=" transition-colors duration-300 hover:text-deep-purple-accent-400"
              target="blank"
            >
            ...
            <a
              href="https://www.facebook.com/khaled.nashwan.395"
              className=" transition-colors duration-300 hover:text-deep-purple-accent-400"
              target="blank"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm ">© Copyright 2023 Inc. All rights reserved.</p>
